...
const includesAny = (haystack, needles) => needles.filter((needle) => {
...
export const matchJob = (job, profile) => {
    ...
    const detailText = normalizeText([job.description ?? '', ...job.requirements].join(' '));
