...
import { DEFAULT_BROWSER_SKILL_CONFIG, validateBrowserPolicy, } from '../../src/browser/browser-policy.js';
const config = {
...
describe('browser policy', () => {
    ...
    it.each(['payment-confirmation', 'auth-token', 'captcha-challenge', 'otp-entry', 'login-page'])('rejects actions containing %s', (action) => {
        const unsafeRequest = {
            ...request,
            actions: [action],
        };
