...
const createJobInput = (overrides = {}) => ({
    source: 'boss',
    title: 'Data Analyst',
    company: 'Acme',
    location: 'Shanghai',
...
describe('job ledger', () => {
    it('标准化岗位字段并为同一 URL 生成确定性身份', () => {
        const normalized = normalizeJob(createJobInput({
        ...
        const sameJob = normalizeJob(createJobInput({
            title: 'Senior Data Analyst',
            company: 'ACME',
            location: 'Shanghai',
            requirements: ['SQL', 'Python'],
...
//# sourceMappingURL=job-ledger.test.js.map