...
describe('local job adapters', () => {
    ...
    it('从明确文件和已配置目录收集 Markdown/JSON 岗位，并复用 dedupeJobs 保留 existing 历史对象', async () => {
        ...
        await import('node:fs/promises').then(({ mkdir }) => mkdir(configuredDirectory, { recursive: true }));
...
//# sourceMappingURL=local-adapters.test.js.map