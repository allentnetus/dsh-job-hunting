...
describe('resume assessor', () => {
    ...
    it('用户确认的 correction 会覆盖评估事实与证据，但不改写 extractedText', async () => {
        ...
        expect(assessment.suggestions).toEqual(expect.arrayContaining([
    ...
    it('拒绝对已 assessed 的简历再次评估', async () => {
        ...
        await expect(assessorModule.assessResume(createParsedResume({
            state: 'assessed',
            assessment: {
                schemaVersion: 'resume-assessment/v1',
                assessor: 'baseline-deterministic',
...
//# sourceMappingURL=resume-assessor.test.js.map