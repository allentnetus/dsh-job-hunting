...
export const createResumeParseError = (init: ResumeParseErrorInit): ResumeParseError =>
  new ResumeParseError(init);

export const getResumeDocumentState = (document: ResumeDocument): ResumeDocumentState =>
