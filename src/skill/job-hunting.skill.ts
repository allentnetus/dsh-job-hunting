...
export const jobHuntingSkill: SkillRegistration = {
  name: 'job-hunting',
  description:
    'Personal resume assessment, local JD/job organization and matching, static site generation, and interest pool management; integrated BrowserSkill (Tencent/BrowserSkill) collection is read-only.',
  whenToUse:
    'Use for local-first job hunting workflows after resolving the active Workspace.',
  source: 'runtime',
  content: `
