...
export const jobHuntingSkill: SkillRegistration = {
  name: 'job-hunting',
  description:
    'Personal resume assessment, local JD/job organization and matching, static site generation, and interest pool management; integrated BrowserSkill collection is read-only.',
  whenToUse:
